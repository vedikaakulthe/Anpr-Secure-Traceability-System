...
│   ├── main.py          # FastAPI application & AI inference logic
│   └── database.py      # SQLite schema and logging functions
├── outputs/             # Sample detection images and log snippets
├── models/              # Directory for YOLO weights (yolov8m.pt)
├── Dockerfile           # Optimized build for Edge hardware (ARM64)
